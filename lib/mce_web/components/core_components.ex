defmodule MceWeb.CoreComponents do
  @moduledoc """
  ...
  attr :auto_dismiss, :integer,
    default: nil,
    doc: "auto-dismiss after milliseconds (nil to disable)"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MceWeb.Gettext, "errors", msg, opts)
    end
  end
