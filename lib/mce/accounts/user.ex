defmodule Mce.Accounts.User do
  use Ecto.Schema
  ...
  @doc """
  A user changeset for registration with email, password, and nickname.
  """
  ...
  """
  def valid_password?(%Mce.Accounts.User{hashed_password: hashed_password}, password)
