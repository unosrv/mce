defmodule MceWeb.UserAuthTest do
  use MceWeb.ConnCase, async: true

  alias Mce.Accounts
  alias Mce.Accounts.Scope
  alias MceWeb.UserAuth

  import Mce.AccountsFixtures

  @remember_me_cookie "_mce_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MceWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
